...
# An ERC20 token faucet on the Polygon Mumbai Testnet

This Dapp allows users to receive 100 FCT on the Polygon Mumbai Testnet and to send FCT to other addresses.
